...
-- Created on Wed Nov  6 17:09:05 2013
-- 
...
CREATE UNIQUE INDEX affiliationgroup ON PP_GROUP_MEMBERSHIPS (AFFILIATION_GROUP);

CREATE UNIQUE INDEX both02 ON PP_GROUP_MEMBERSHIPS (PRIMARY_GROUP, AFFILIATION_GROUP);

CREATE UNIQUE INDEX primarygroup ON PP_GROUP_MEMBERSHIPS (PRIMARY_GROUP);
