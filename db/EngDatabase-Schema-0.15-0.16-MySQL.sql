-- Convert schema 'db/EngDatabase-Schema-0.15-MySQL.sql' to 'EngDatabase::Schema v0.16':;

BEGIN;

ALTER TABLE PP_GROUPS CHANGE COLUMN GROUP_NAME GROUP_NAME text NULL,
                      CHANGE COLUMN GROUP_DESC GROUP_DESC text NULL;
