...
CREATE TABLE "PP_USERS" (
  ...
  "STATUS_ID" number(11),
  "STATUS_DATE" date,
  "PRIMARY_GROUP" number(11),
  "AFFILIATION_GROUP" number(11),
  PRIMARY KEY ("USER_ID"),
...
ALTER TABLE "PP_USERS" ADD CONSTRAINT "PP_USERS_PRIMARY_GROUP_fk" FOREIGN KEY ("PRIMARY_GROUP") REFERENCES "PP_GROUPS" ("GROUP_ID") ON DELETE CASCADE;
