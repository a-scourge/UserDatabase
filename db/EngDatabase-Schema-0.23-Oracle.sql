...
-- Created on Wed Nov  6 17:09:06 2013
-- 
--
-- Table: PP_ATTRIBUTES
--;
...
CREATE TABLE "PP_GROUP_MEMBERSHIPS" (
  ...
  "USER_ID" number(11) NOT NULL,
  "GROUP_ID" number(11) NOT NULL,
  "PRIMARY_GROUP" number(1),
  "AFFILIATION_GROUP" number(1),
  PRIMARY KEY ("GROUP_MEMBERSHIP_ID"),
  CONSTRAINT "u_PP_GROUP_MEMBERSHIPS_affilia" UNIQUE ("AFFILIATION_GROUP"),
  CONSTRAINT "u_PP_GROUP_MEMBERSHIPS_both" UNIQUE ("PRIMARY_GROUP", "AFFILIATION_GROUP"),
  CONSTRAINT "u_PP_GROUP_MEMBERSHIPS_primary" UNIQUE ("PRIMARY_GROUP")
)
ENGINE    InnoDB;
