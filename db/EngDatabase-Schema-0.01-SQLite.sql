...
-- Created on Mon Sep  2 16:19:16 2013
-- 
...
CREATE TABLE PP_USERS (
  ...
  GECOS  NOT NULL,
  HOMEDIR  NOT NULL,
  PASSWORD_EXPIRY_DATE  NOT NULL,
  PROPAGATION  NOT NULL,
  STATUS_ID  NOT NULL,
  STATUS_EFFECTIVE_DATE  NOT NULL,
  PRIMARY KEY (USER_ID),
...
CREATE TABLE PP_USER_ATTRIBUTES (
  ...
  FOREIGN KEY (STATUS_ID) REFERENCES PP_USERS(STATUS_ID)
);

CREATE INDEX PP_USER_ATTRIBUTES_idx_STATUS_ID ON PP_USER_ATTRIBUTES (STATUS_ID);
