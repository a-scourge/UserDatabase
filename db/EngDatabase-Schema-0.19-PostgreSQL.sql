...
-- Created on Wed Oct  2 12:53:39 2013
-- 
--
-- Table: PP_ATTRIBUTES.
--
...
CREATE TABLE "PP_GROUPS" (
  ...
  CONSTRAINT "PP_GROUPS_GID" UNIQUE ("GID"),
...
CREATE TABLE "PP_USERS" (
  ...
  "STATUS_DATE" ,
  PRIMARY KEY ("USER_ID"),
  CONSTRAINT "PP_USERS_CRSID" UNIQUE ("CRSID"),
  CONSTRAINT "PP_USERS_ENGID" UNIQUE ("ENGID"),
  CONSTRAINT "PP_USERS_ENGID_CRSID_UID" UNIQUE ("ENGID", "CRSID", "UID"),
  CONSTRAINT "PP_USERS_UID" UNIQUE ("UID")
);
...
ALTER TABLE "PP_USER_CAPABILITIES" ADD CONSTRAINT "PP_USER_CAPABILITIES_fk_USER_ID" FOREIGN KEY ("USER_ID")
  REFERENCES "PP_USERS" ("USER_ID") DEFERRABLE;
