...
CREATE UNIQUE INDEX affiliationgroup ON PP_GROUP_MEMBERSHIPS (USER_ID, AFFILIATION_GROUP);

CREATE UNIQUE INDEX both ON PP_GROUP_MEMBERSHIPS (USER_ID, PRIMARY_GROUP, AFFILIATION_GROUP);

CREATE UNIQUE INDEX primarygroup ON PP_GROUP_MEMBERSHIPS (USER_ID, PRIMARY_GROUP);
