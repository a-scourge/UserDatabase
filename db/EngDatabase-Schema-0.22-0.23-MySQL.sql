...
ALTER TABLE PP_GROUP_MEMBERSHIPS DROP INDEX affiliationgroup,
                                 ...
                                 DROP COLUMN PRIMARY_GROUP,
                                 DROP COLUMN AFFILIATION_GROUP;

ALTER TABLE PP_STATUSES CHANGE COLUMN STATUS_NAME STATUS_NAME varchar(100) NULL;

ALTER TABLE PP_USERS DROP INDEX CRSID,
                     DROP INDEX ENGID,
                     ADD COLUMN PRIMARY_GROUP integer(11) NULL,
                     ADD COLUMN AFFILIATION_GROUP integer(11) NULL,
                     ...
                     ADD INDEX PP_USERS_idx_PRIMARY_GROUP (PRIMARY_GROUP),
                     ADD CONSTRAINT PP_USERS_fk_PRIMARY_GROUP FOREIGN KEY (PRIMARY_GROUP) REFERENCES PP_GROUPS (GROUP_ID) ON DELETE CASCADE ON UPDATE CASCADE;
