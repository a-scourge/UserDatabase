-- Convert schema 'db/EngDatabase-Schema-0.14-MySQL.sql' to 'EngDatabase::Schema v0.15':;

BEGIN;

ALTER TABLE PP_GROUPS CHANGE COLUMN GROUP_DESC GROUP_DESC  NULL;

ALTER TABLE PP_GROUP_MEMBERSHIPS ADD COLUMN PRIMARY_GROUP integer NOT NULL,
                                 ADD COLUMN AFFILIATION_GROUP integer NOT NULL;
