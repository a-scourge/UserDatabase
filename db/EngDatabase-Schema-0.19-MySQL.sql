...
CREATE TABLE `PP_USERS` (
  ...
  PRIMARY KEY (`USER_ID`),
  UNIQUE `PP_USERS_CRSID` (`CRSID`),
  UNIQUE `PP_USERS_ENGID` (`ENGID`),
  UNIQUE `PP_USERS_ENGID_CRSID_UID` (`ENGID`, `CRSID`, `UID`),
  UNIQUE `PP_USERS_UID` (`UID`),
...
CREATE TABLE `PP_USER_CAPABILITIES` (
  ...
  `USER_ID` integer NOT NULL,
  `AD_ENABLED` integer NULL,
  `AD_PASSWORD` integer NULL,
  `AUTOMOUNTER` integer NULL,
  `TRUST_ALLOWED` integer NULL,
  `UNIX_PASSWD` integer NULL,
  `UNIX_ENABLED` integer NULL,
  `PROP_DEPT` integer NULL,
  `PROP_MAIL` integer NULL,
  `PROP_DIVA` integer NULL,
  `PROP_DIVB` integer NULL,
  `PROP_DIVF` integer NULL,
  `PROP_FLUID` integer NULL,
  `PROP_STRUCT` integer NULL,
  `PROP_WHITTLE` integer NULL,
  `PROP_WORKS` integer NULL,
  `PROP_TEST` integer NULL,
